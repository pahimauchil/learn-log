...
console.log(airline.indexOf('o')); //5  ...gives index of 1st occuring 
console.log(airline.lastIndexOf('o')); //this gives the last occuring postion of mentioned string

console.log(airline.indexOf('digo')); //gives starting postion of stirng 

console.log(airline.slice(4)); //go ..this slices first 4 positons and return remaining
console.log(airline.slice(2,5)); //di
...
console.log(airline.slice(-2)); //last 2 postions
